    ...
    def parse(self, html: str, base_url: str, source: str) -> list[SignpostLink]:
        ...
        for element in soup.find_all('link', href=True):
            ...
            for rel in rel_values:
                links.append(
                    SignpostLink(
                        url=normalize_url(base_url, element['href']),
                        rel=str(rel),
...
class LinksetParser:
    ...
    def parse(self, content: str, base_url: str, source: str, content_type: str | None = None) -> list[SignpostLink]:
        ...
        for entry in items:
            ...
            for rel, rel_value in entry.items():
                ...
                for obj in rel_value:
                    ...
                    links.append(
                        SignpostLink(
                            url=normalize_url(base_url, obj['href']),
                            rel=rel,
                            type=obj.get('type'),
